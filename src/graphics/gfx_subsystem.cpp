...
Ref<Graphics::Sprite>::SharedPtr GfxSubsystem::createSprite(const std::string & fragments)
{
   ...
   Ref<Graphics::Sprite>::SharedPtr newSprite(new Graphics::Sprite(renderer, renderer->getNativeSize()));
